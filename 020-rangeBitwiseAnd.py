...
#         #     dp[lis[0]].append(lis[1])
#         #
#         # def sub_solver(i, cur_visited):
#         #     if i in cur_visited:
#         #         return False
#         #     elif i in visited:
#         #         return True
...
#         #             if not sub_solver(ele, cur_visited):
#         #                 return False
...
#         #     if not sub_solver(i, set()):
#         #     # if i not in visited and not sub_solver(i, set()):
#         #         return False
#         # return True
#
#
...
# 网上答案,不用构建节点类,和我最初的想法一样,,,直接字典套字典...(禁止套娃..手动滑稽
class Trie:
...
#         # return res
#
#         # # 前缀和 + 二分搜索 O(nlogn) 感觉他写的不太好，主要在利用模块
#         # import bisect
...
#         while lo < hi:
#             mi = (lo + hi) >> 1
#             if not any(pre[i] - pre[i-mi] >= s for i in range(mi, len(pre))):
#                 lo = mi + 1
#             else:
#                 hi = mi
#         return lo
...
#
# numCourses = 4
# prerequisites = [[0,1],[0,2],[1,3],[2,1]]       # [3,1,2,0]
#
# # numCourses = 3
# # prerequisites = [[1,0],[0,2],[2,1]]       # []
# #
# # numCourses = 5
# # prerequisites = [[1,2],[2,3],[3,4],[4,2]]       # F
#
#
# class Solution:
#     def findOrder(self, numCourses, prerequisites):
#         # # 这个是使用邻接表和入度表示图以后，使用广度优先遍历
#         # adjacent = [[] for _ in range(numCourses)]
#         # in_degree = [0] * numCourses
#         # for lis in prerequisites:
#         #     adjacent[lis[1]].append(lis[0])
#         #     in_degree[lis[0]] += 1
#         #
#         # res = []
#         # queue = []
